...
def per_task_execution(idx):
    ...
    features = O.Features.get_features(imgs, feature_type=feature, norm_type=norm)

    # run the outlier detection algorithm
    O.OutlierDetector.detect_outliers(
        features=features, imgs=imgs, pyod_algorithm="VAE", id_=idx, **arguments
    )
