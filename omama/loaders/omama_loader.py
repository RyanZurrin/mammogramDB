...
class OmamaLoader(DataLoader):
    ...
    def __init__(
        ...
        config_num : int
            ...
            3: Omama dataset for 3D whitelist -> 67572 images
            ...
            36. IndexCancer from final 2D dataset -> 5803 images
        ...
        if csv_paths is None:
            csv_paths = [
                ...
                r"/raid/data01/deephealth/labels/dh_dcm_ast_labels" r".csv",
            ]
        else:
            csv_paths = csv_paths
        ...
        if config_loc is None:
            config_loc = "/raid/mpsych/OMAMA/DATA/config_files/config_nums.ini"
        else:
