    ...
    **kwargs
    ...
    if is_siamese:
        ...
        if isinstance(is_siamese, str) and is_siamese == "concat":
            outs = [
                keras.layers.Concatenate()([feats0[1], feats1[1]]),
                keras.layers.Concatenate()([feats0[2], feats1[2]]),
                keras.layers.Concatenate()([feats0[3], feats1[3]]),
            ]
        else:
            outs = [
                keras.layers.Subtract()([feats0[1], feats1[1]]),
                keras.layers.Subtract()([feats0[2], feats1[2]]),
                keras.layers.Subtract()([feats0[3], feats1[3]]),
            ]
    ...
    return retinanet.retinanet(
        inputs=inputs, num_classes=num_classes, backbone_layers=outs, **kwargs
    )
