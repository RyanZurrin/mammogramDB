...
class MobileNetBackbone(Backbone):
    ...
    def __init__(self, backbone):
        ...
        self.custom_objects.update({"relu6": relu6, "DepthwiseConv2D": DepthwiseConv2D})
...
def mobilenet_retinanet(
    ...
    mobilenet = keras.models.Model(
        inputs=inputs, outputs=layer_outputs, name=mobilenet.name
    )
