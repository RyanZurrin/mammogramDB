...
class PACSInput(DirMonitorInput):
    def __init__(
        ...
        self.scp_config_file_path = (
            os.path.realpath(__file__ + "/../../pacs_helpers/storescp.cfg")
            if scp_config_file_path is None
    ...
    def start_receiver(self):
        ...
        self.logger.info(
            log_line(
                -1,
                "Dicom receiver was started in port={} pid={}".format(
