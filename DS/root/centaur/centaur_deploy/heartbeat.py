...
if __name__ == "__main__":
    ...
    args_parser.add_argument(
        "--period_in_seconds", "-p", type=int, help="period in seconds", default=60
    )
    args = args_parser.parse_args()
    print(
        "Hearbeat generator will write current timestamp every {} seconds to the file {}".format(
            args.period_in_seconds, args.heartbeat_log_file
        )
    )
