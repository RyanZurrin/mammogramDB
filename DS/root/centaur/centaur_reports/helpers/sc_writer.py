...
class SCWriter(object):
    ...
    def set_pixel_data(self):
        ...
        self.sc.BitsStored = (
            math.ceil(math.log2(max_pixel_val)) if max_pixel_val != 0 else 1
        )
    ...
    def set_sc_metadata(self):
        ...
        file_meta.ImplementationVersionName = self.report_info[
            "ImplementationVersionName"
        ]
        file_meta.SourceApplicationEntityTitle = self.report_info[
