...
#         if 'DXm' in ds_dir:
#             this_ds = helpers.dh_dcmread('{}/{}'.format(os.path.join(dcm_dir, study), ds_dir))
...
if __name__ == "__main__":
    file_path = (
        "/efs/ericwu/docker/centaur_v5/outputs/test4/"
    ...
    srwriter.generate(
        results_json["model_results"], results_json["metadata"], output_dir
    )
