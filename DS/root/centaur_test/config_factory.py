...
class ConfigFactory:
    ...
    @classmethod
    def VerificationInternalConfigFactory(
        cls,
        input_dir=const_deploy.DEFAULT_INPUT_FOLDER,
        output_dir=const_deploy.DEFAULT_OUTPUT_FOLDER,
        optional_params_dict=None,
    ):
        """
        ...
        factory._set_internal_config(
            input_dir, output_dir, additional_params=optional_params_dict
        )
        config_dict = {}
    ...
    def ResearchConfigFactory(cls, input_dir, output_dir, run_mode, **kwargs):
        ...
        factory._set_internal_config(
            ...
            output_dir,
            additional_params={
                "checker_mode": Checker.CHECKER_RESEARCH,
                "run_mode": run_mode,
            },
        )
