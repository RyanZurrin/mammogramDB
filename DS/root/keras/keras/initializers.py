...
class Identity(Initializer):
    ...
    def __call__(self, shape, dtype=None):
        if len(shape) != 2 or shape[0] != shape[1]:
            raise ValueError(
                "Identity matrix initializer can only be used "
...
def glorot_normal(seed=None):
    ...
    """
    return VarianceScaling(scale=1.0, mode="fan_avg", distribution="normal", seed=seed)
...
def glorot_uniform(seed=None):
    ...
    # References
        ...
        http://jmlr.org/proceedings/papers/v9/glorot10a/glorot10a.pdf
    """
    return VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform", seed=seed)
...
def he_normal(seed=None):
    ...
    """
    return VarianceScaling(scale=2.0, mode="fan_in", distribution="normal", seed=seed)
