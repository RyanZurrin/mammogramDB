...
def NASNet(
    ...
    x = BatchNormalization(
        ...
        epsilon=1e-3,
        name="stem_bn1",
        use_batch_inf=bn_use_batch_inf,
        use_batch_train=bn_use_batch_train,
    )(x)
...
def _adjust_block(
    p, ip, filters, block_id=None, bn_use_batch_inf=False, bn_use_batch_train=True
):
...
def _normal_a_cell(
    ip, p, filters, block_id=None, bn_use_batch_inf=False, bn_use_batch_train=True
):
