...
def create_network(
    ...
    model.add(
        Dense(
            dense_units, input_shape=(max_words,), kernel_initializer=kernel_initializer
        )
    )
...
plt.plot(
    range(epochs), history_model1.history["val_loss"], "g-", label="Network 1 Val Loss"
)
plt.plot(
    range(epochs), history_model2.history["val_loss"], "r-", label="Network 2 Val Loss"
)
plt.plot(range(epochs), history_model1.history["loss"], "g--", label="Network 1 Loss")
plt.plot(range(epochs), history_model2.history["loss"], "r--", label="Network 2 Loss")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
