...
def test_preprocess_input_symbolic():
    ...
    outputs1 = Lambda(
        lambda x: utils.preprocess_input(x, "channels_last"), output_shape=x.shape[1:]
    )(inputs)
    ...
    outputs2 = Lambda(
        lambda x: utils.preprocess_input(x, "channels_first"), output_shape=x2.shape[1:]
    )(inputs2)
    ...
    outputs1 = Lambda(
        lambda x: utils.preprocess_input(x, "channels_last"), output_shape=x.shape
    )(inputs)
    model1 = Model(inputs, outputs1)
    ...
    outputs2 = Lambda(
        lambda x: utils.preprocess_input(x, "channels_first"), output_shape=x2.shape
    )(inputs2)
    model2 = Model(inputs2, outputs2)
