...
def test_text_to_word_sequence_unicode():
    text = "ali! veli? kırk dokuz elli"
    assert text_to_word_sequence(text) == ["ali", "veli", "kırk", "dokuz", "elli"]


def test_tokenizer_unicode():
    texts = ["ali veli kırk dokuz elli", "ali veli kırk dokuz elli veli kırk dokuz"]
